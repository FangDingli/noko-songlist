<template>
  <div class="bg_img noko_cursor bg-no-repeat z-0 fixed w-full h-full top-0"></div>
  ...
  <div class="z-1 bg-blue bg-op-20 backdrop-blur-20px min-h-screen mt-60vh transform-gpu">
    <div class="w-80% m-x-auto lt-sm:w-full">
      ...
      <div
        v-show="!state.songlistState.searchedSong || state.songlistState.searchedSong.length === 0"
